...
function applyFile(source, destination, expected, label){
...
applyFile(path.join(root,"patch-v12c","server.js"),path.join(target,"server.js"),"6143eff1de109f41ad777ac4c08e49440c8a0c32515ad72e740367ed8564cc1f","DeployBridge v1.2 route patch");
