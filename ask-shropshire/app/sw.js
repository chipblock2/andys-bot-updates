const CACHE='ask-shropshire-v6';
const APP_SHELL=['./','./index.html','./app.css','./app.js','./pwa.js','./feed-patch.js','./manifest.webmanifest','./privacy.html','./accessibility.html','./submit-event.html','./claim-business.html','./alerts.html','./deals.html','./submit-offer.html','./intake.js','./deals.js','./icon.svg','./maskable.svg','./icon-192.png','./icon-512.png'];
