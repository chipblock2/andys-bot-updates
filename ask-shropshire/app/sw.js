const CACHE='ask-shropshire-v3';
const APP_SHELL=['./','./index.html','./app.css','./app.js','./pwa.js','./feed-patch.js','./manifest.webmanifest','./privacy.html','./accessibility.html','./icon.svg','./maskable.svg','./icon-192.png','./icon-512.png'];
