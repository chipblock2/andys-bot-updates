const CACHE='ask-shropshire-v2';
const APP_SHELL=['./','./index.html','./app.css','./app.js','./pwa.js','./feed-patch.js','./manifest.webmanifest','./privacy.html','./accessibility.html','./icon.svg','./maskable.svg'];
